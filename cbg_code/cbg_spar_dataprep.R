...
my_data <- fread('~/Documents/data/phaseEncodingData/MarkSmoker_glucose_29-6-2022.csv', skip = 2)
my_data <- fread('~/Documents/data/phaseEncodingData/EileenKesson_glucose_28-6-2022.csv', skip = 2)
